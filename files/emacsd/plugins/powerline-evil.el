...
(defface powerline-evil-normal-face
  '((t (:foreground "darkgreen" :background "lightgreen" :inherit powerline-evil-base-face)))
  "Powerline face for evil NORMAL state."
  :group 'powerline)

(defface powerline-evil-insert-face
  '((t (:foreground "darkblue" :background "cyan" :inherit powerline-evil-base-face)))
  "Powerline face for evil INSERT state."
  :group 'powerline)

(defface powerline-evil-visual-face
  '((t (:foreground "brown" :background "orange" :inherit powerline-evil-base-face)))
